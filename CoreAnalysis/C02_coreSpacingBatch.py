...
#            zString = f'coszen{coszen_bin_edges[iC]:.2f}'
            ...
            filename = f"{identifier}_Cores_Gen2Design_{depth}mRefl_{type}_{refl_coef}R_{space:.2f}km_{Estring}_{zString}_cores{throws}"
            ...
            cmd = f"python {detector_sim} {detector_filename} {config_file} {output_filename} {output_filename_nur} {throws} {eLow} {eHigh} {cLow} {cHigh} {type} {depth} {refl_coef} {space}\n"
