...
if __name__ == '__main__':
    ...
    CONFIG = {
        ...
        'parameter_files_template': os.path.join(data_path, "nurFiles", "{date}", "{date}_Station{station_id}_{parameter_name}*_Xevts_*.npy").replace("_Xevts_", "_*evts_"), # Adjusted for glob
