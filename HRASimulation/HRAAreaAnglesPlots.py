...
if __name__ == "__main__":
    ...
    for station in dir_trig:
        ...
        zenith, recon_zenith, azimuth, recon_azimuth = HRAAnalysis.getAngles(HRAeventList, weight_name=station)
    ...
    zenith, recon_zenith, azimuth, recon_azimuth = HRAAnalysis.getAngles(HRAeventList, weight_name='combined_reflected')
    ...
    zenith, recon_zenith, azimuth, recon_azimuth = HRAAnalysis.getAngles(HRAeventList, weight_name='combined_direct')
    ...
    for i in [2, 3, 4, 5, 6, 7]:
        ...
        zenith, recon_zenith, azimuth, recon_azimuth = HRAAnalysis.getAngles(HRAeventList, weight_name=weight_name)
