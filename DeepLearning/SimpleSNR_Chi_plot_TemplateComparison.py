...
data_to_plot.append(f'DeepLearning/data/{datapass}/Station{station_id}/Station{station_id}_SNR_Chi.npy')
...
savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_Stn{station_id}.png'
...
savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_wRCR_Stn{station_id}.png'
fig.savefig(savename)
print(f'Saved {savename}')

savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_RCR_Stn{station_id}.png'
...
savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_wRCR_wBacklobe_Stn{station_id}.png'
fig.savefig(savename)
print(f'Saved {savename}')

savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_Backlobe_Stn{station_id}.png'
fig2.savefig(savename)
print(f'Saved {savename}')
...
savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_wRCR_wBacklobe_wSelected_Stn{station_id}.png'
fig.savefig(savename)
print(f'Saved {savename}')

savename = f'DeepLearning/plots/Station_{station_id}/TemplateComparison_ChiSNR_Selected_Stn{station_id}.png'
fig2.savefig(savename)
print(f'Saved {savename}')
